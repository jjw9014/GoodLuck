...
public class AuthUtil {
     ...
     * 微信授权url前缀
     */
    public static final String WX_AUTH_URL_PREFIX = "https://open.weixin.qq.com/connect/oauth2/authorize";

    /**
     * 微信授权后返回url
     */
    public static final String BAKUP_URL = "https://www.yyzheng.cn/o2o/callBack";
